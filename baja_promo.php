...
<div class="container-fluit"> 
    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <form action="baja_promo_sql.php" method="POST">
                <div class="mb-3">
                    <label for="Descuento" class="form-label">Eliminar  promo </label>
                    <input type="text"  class="form-control" id="Descuento" name="Descuento" value=<?php echo $Descuento ?>>
                </div>
                <div class="mb-3">
                    <label for="activ" class="form-label"> Eliminar la activ</label>
