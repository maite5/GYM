...
<html lang="es">
  <head>
    ...
    $consulta6 = "select distinct * from entrenador";
    ...
    while($fila2 = mysqli_fetch_assoc($resultado2)){
        $entrenador_total = $fila2['alumnos'];  
    } 
  ...
  <body background="img/font.jpg" class="container-fluid">   
    ...
    <div class="row">
        ...
        <div class="col-3">
            <div class="d-grid gap-2">
                <button type="button" class="btn btn-outline-primary"> Inscriptos: <?php echo $entrenador_total;  ?></button> 
            </div>
        </div>
        <div class="col-3">
            <div class="d-grid gap-2">
                <button type="button" class="btn btn-outline-success">
                    <a href="alta_actividad.php" >  Registrar actividad </a> 
                </button> 
            </div>
        </div>
    </div><br> 
      ...
      <!-- <table class="table table-bordered table-sm table-hover table-dark" > -->
        ...
        <thead>
                <tr class="text-center">
                    <td>Nombre</td><td>Modalidad semanal</td><td>Fecha de Inicio</td><td>Fecha fin</td><td>Hora inicio</td> <td>Hora fin</td><td> Cod entrenador </td> <td>Turno</td><td>Precio</td> <td>   Editar 
