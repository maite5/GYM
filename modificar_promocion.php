...
<html lang="en">
  <head>
    ...
    <title>  Modificación de promocion !</title>
...
<div class="container-fluit"> 
    ...
    <div class="alert alert-dark text-center fst-italic" role="alert">
        <h3>Modificación de promocion </h3> 
    </div>
    <br>
    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <form action="modificar_promo_sql.php" method="POST">
                <div class="mb-3">
                    <label for="Descuento" class="form-label">Modificar promo </label>
                    <input type="text" disabled class="form-control" id="Descuento" name="Descuento" value=<?php echo $Descuento ?>>
                </div>
                <div class="mb-3">
                    <label for="activ" class="form-label"> Modificar la activ</label>
                    <input type="text" class="form-control" id="activ" name="activ"  value=<?php echo $activ ?> >
                </div>
