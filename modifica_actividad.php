...
<html lang="en">
  <head>
    ...
    <title>  Modificación de actividad !</title>
...
<div class="container-fluit"> 
    ...
    <div class="alert alert-dark text-center fst-italic" role="alert">
        <h3>Modificación de actividad </h3> 
    </div> 
    <br>
